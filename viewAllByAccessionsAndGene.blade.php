...
<body>
    ...
    @php
        ...
        if (isset($result_arr) && is_array($result_arr) && !empty($result_arr)) {
                        ...
                        for ($k = 0; $k < count($genotype_description_array); $k++) {
                            ...
                            if (preg_match('/missense.variant/i', $genotype_description_array[$k])) {
                                ...
                                if (count($temp_value_arr) > 3) {
                                    $genotype_description_array[$k] =
                                        $temp_value_arr[0] . '|' . $temp_value_arr[2] . '|' . $temp_value_arr[3];
            ...
            echo "<button onclick=\"queryAllByAccessionsAndGene('" .
                $organism .
                "', '" .
                $dataset .
                "', '" .
...
<script src="{{ asset('system/home/AlleleCatalogTool/js/viewAllByAccessionsAndGene.js') }}" type="text/javascript">
</script>
