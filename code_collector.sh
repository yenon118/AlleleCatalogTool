...
grep -e "Allele Catalog" -e "AlleleCatalog" /data/html/Prod/KBCommons_multi/routes/web.php > /data/html/Prod/KBCommons_multi/resources/views/system/tools/AlleleCatalogTool/config/web.php
